...
## GitHub 업로드 전 추천 정리 사항

오픈소스 저장소로 공개하기 전에 아래 항목을 함께 정리하면 좋습니다.

- 저장소 설명(About)에 프로젝트 목적 한 줄 추가
- 릴리스 업로드 시 macOS / Windows ZIP 첨부
- 스크린샷 1~2장 추가
- 향후 계획이 있다면 `CHANGELOG.md` 또는 Releases 활용
- 필요 시 `.github/workflows/`에 플랫폼별 빌드 자동화 추가
